 ...
 * @package    \Plugin_Name_Dir\Includes\PageHandlers
 * @author     Your_Name <youremail@nomail.com>
 * @see        \Plugin_Name_Dir\Includes\Functions\Utilityclass-aral-dashboard-handler.php
 * @see        \Plugin_Name_Dir\Includes\PageHandlers\Contracts\Page_Handler
 */
class ARAL_Exp_Files_Handler implements Page_Handler {
	...
	public function render() {
		...
		Utility::load_template( 'aral-exp-files.aral-exp-files', compact( 'dash_assets_url' ), 'front' );
		exit;
	}
}
