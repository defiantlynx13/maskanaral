...
use Plugin_Name_Dir\Includes\PageHandlers\ARAL_All_Prop_Handler;
use Plugin_Name_Dir\Includes\PageHandlers\ARAL_Dashboard_Handler;
use Plugin_Name_Dir\Includes\PageHandlers\ARAL_Auth_Handler;
use Plugin_Name_Dir\Includes\PageHandlers\ARAL_Exp_Files_Handler;
use Plugin_Name_Dir\Includes\PageHandlers\ARAL_Faq_Handler;
use Plugin_Name_Dir\Includes\PageHandlers\ARAL_Home_Handler;
use Plugin_Name_Dir\Includes\PageHandlers\ARAL_Last_Prop_Handler;
use Plugin_Name_Dir\Includes\PageHandlers\ARAL_Not_Found_Handler;
use Plugin_Name_Dir\Includes\PageHandlers\ARAL_Prop_Handler;
use Plugin_Name_Dir\Includes\PageHandlers\ARAL_Recover_password_Handler;
use Plugin_Name_Dir\Includes\PageHandlers\ARAL_User_Register_Handler;
...
class Router {
	...
	private function set_default_routes() {
		$this->routes = [
			'/aral-dashboard'        => ARAL_Dashboard_Handler::class,
			'/auth'        => ARAL_Auth_Handler::class,
			'/recover-password'        => ARAL_Recover_password_Handler::class,
			'/aral-register'        => ARAL_User_Register_Handler::class,
			'/aral-prop'        => ARAL_Prop_Handler::class,
			'/aral-home'        => ARAL_Home_Handler::class,
			'/aral-all-prop'        => ARAL_All_Prop_Handler::class,
			'/aral-not-found'        => ARAL_Not_Found_Handler::class,
			'/aral-faq'        => ARAL_Faq_Handler::class,
			'/aral-exp-files'        => ARAL_Exp_Files_Handler::class,
			'/last-prop'        => ARAL_Last_Prop_Handler::class,
		];
