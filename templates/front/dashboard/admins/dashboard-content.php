<div id="main">
    ...
    Utility::load_template( 'dashboard.admins.general.sidebar',  compact( 'dash_assets_url' ), 'front' );
...
<!--                                    درخواست های شما-->
                                ...
                                <button type="button" id="new_prop_request" class="btn btn btn-outline-success btn-pulse d-none" style="">
                                    ...
                                    <div class="table-responsive">
                                        <table id="user_prop_request_tbl" class="table table-striped mb-0">
                                            ...
                                            <tr>
                                                ...
                                                <th class="text-center">فایل های حذف شده</th>
                            ...
                            <div class="row mt-3">
                                ...
                                $sql = "SELECT * FROM {$table_name} WHERE status='completed'";
...
<div class="modal fade" id="show_excluded_prop_modal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalCenterTitle">لیست املاک حذف شده از لیست پیشنهادی برای این درخواست</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <i class="ti-close"></i>
                </button>
            </div>
            <div class="modal-body">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-body" id="show_excluded_prop_modal_tbl">
                                </div>
                            </div>
                        </div>
                    </div>
