    ...
    <div class="navigation-menu-body">
        ...
        <div class="navigation-menu-group">
            ...
            <div class="open" id="dashboards">
                <ul>
                    <li class="navigation-divider">میزکار</li>
                    <li><a href="<?php echo home_url('aral-dashboard') ?>">مدیریت درخواست ها</a></li>
                    <li><a target="_blank" href="<?php echo admin_url('edit.php?post_type=aralproperty&page=aral_archive_managment') ?>">مدیریت آرشیو</a></li>
                    <li><a target="_blank" href="<?php echo admin_url('edit.php?post_type=aralproperty&page=aral_sale_archive_managment') ?>">مدیریت بایگانی</a></li>
                    <li><a target="_blank" href="<?php echo admin_url('edit.php?post_type=aralproperty&page=aral_prop_owner_managment') ?>">دفترچه تلفن مالکین</a></li>
                </ul>
            </div>
        </div>
    </div>
