<?php
/**
 * Plugin Name:      Maskan Aral New Features
...
class ARAL {
	...
	private function __construct() {
		...
		register_uninstall_hook(
			__FILE__,
			array( 'Plugin_Name_Plugin', 'uninstall_ARAL' )
		);

        self::run_ARAL_plugin();
	 ...
	 * @since  1.0.0
	 */
	public static function run_ARAL_plugin() {
		$plugin = new Core();
		$plugin->run();
	}
	 ...
	 * @since  1.0.0
	 */
	public static function uninstall_ARAL() {
		Uninstall::uninstall();
	}
	 ...
	 * @since  1.0.0
	 */
	public function deactivate_ARAL() {
